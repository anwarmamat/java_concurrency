...
/**
  * 
 * Driver program for using Callable tasks and executors to sum an array
 *
 */

public class SumDriverCallableTask {
	...
	public static void main(String[] args) {
		...
		ParallelIntArraySumCallable ps = new ParallelIntArraySumCallable(nWorkers,nTasks);
